...
1.  **Weather App**
    ...
    *   **Prompt Used:**  "Create a Weather native Android app in Java that consumes data from an external API in order to show the current weather and weather forecast for the current user location and for other locations that the User can select"
    *   **Implementations:**
...
2.  **2048 Game**
    ...
    *   **Prompt Used:** Generate a native Android weather app in Java. It should fetch data from an external API to display current weather and forecasts for the user's current location and for user-selectable locations.
    *   **Implementations:**
...
3.  **To-Do Notes App**
    ...
    *   **Prompt Used:** "Generate a native Android To-Do Notes app using Java and Kotlin. Users should be able to create, view, edit and save (locally and remotely) notes, with support for Markdown and plain text formats"
    *   **Implementations:**
...
4.  **Photo Gallery App**
    ...
    *   **Prompt Used:** "Generate a native Android Photo Gallery app. It should list photos from device storage, support different layouts and allow users to view individual photos"
    *   **Implementations:**
...
5.  **Scientific Calculator**
    ...
    *   **Prompt Used:** "Generate a fully-functional native Android scientific calculator app using Java. It should support standard arithmetic operations and common scientific functions (e.g. logarithms, exponents)"
    *   **Implementations:**
...
6.  **Flappy Bird Game**
    ...
    *   **Prompt Used:**  "Generate a fully-functional native Android replica of the Flappy Bird game using Java"
    *   **Implementations:**
